## These 2 functions combined give the user a chance to inverse
## a matrix and store it in the cache, so that in case of multiple
## uses it takes less space on the RAM

## The function below, makeCacheMatrix, stores 4 functions:
...
## second one stored with setinverse(). Note that setinverse() doesn't 
